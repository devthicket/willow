...
func TestTransformVerticesIdentity(t *testing.T) {
	...
	mesh.TransformVertices(src, dst, node.IdentityTransform, RGBA(1, 1, 1, 1))
...
func TestTransformVerticesTranslation(t *testing.T) {
	...
	mesh.TransformVertices(src, dst, transform, RGBA(1, 1, 1, 1))
...
func TestTransformVerticesColorTint(t *testing.T) {
	...
	mesh.TransformVertices(src, dst, node.IdentityTransform, tint)
...
func TestMeshCullingWithOffset(t *testing.T) {
	...
	n.WorldTransform = node.IdentityTransform
