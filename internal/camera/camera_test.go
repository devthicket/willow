...
func TestCameraIdentityViewMatrix(t *testing.T) {
	...
	sx, sy := node.TransformPoint(vm, 0, 0)
...
func TestCameraScrollTo(t *testing.T) {
	cam := NewCamera(types.Rect{X: 0, Y: 0, Width: 800, Height: 600})
	cam.ScrollTo(100, 200, types.TweenConfig{Duration: 1.0, Ease: ease.Linear})
...
func TestCameraScrollToTile(t *testing.T) {
	cam := NewCamera(types.Rect{X: 0, Y: 0, Width: 800, Height: 600})
	cam.ScrollToTile(3, 2, 32, 32, types.TweenConfig{Duration: 0.0001, Ease: ease.Linear})
...
func TestCameraBounds(t *testing.T) {
	cam := NewCamera(types.Rect{X: 0, Y: 0, Width: 100, Height: 100})
	cam.SetBounds(types.Rect{X: 0, Y: 0, Width: 1000, Height: 1000})
...
func TestCameraBoundsSmallWorld(t *testing.T) {
	...
	cam.SetBounds(types.Rect{X: 0, Y: 0, Width: 100, Height: 100})
	cam.X = 0
	cam.Y = 0
	cam.Update(0)
...
func TestCulling_ContainerNeverCulled(t *testing.T) {
	n := &node.Node{}
	n.Type = types.NodeTypeContainer
