<!-- Salvaged 2026-08-20 from the abandoned `refactor/subpackages` branch (tip ca14f55),
     the last copy of the pre-2026-03-16 docs site removed in f368b0a. The rest of that
     site was rewritten and now lives at devthicket.org/src/content/docs/willow/; this
     page had no successor there. APIs referenced below were verified against main on
     2026-08-20 and still exist. -->
