...
// No external asset files  -  the Go Regular font is sourced from willow.GofontBundle.
package main
...
func addLabel(root *willow.Node, font *willow.FontFamily, s string, x, y float64) {
