...
- **Text rendering** - TTF/OTF via signed distance field (SDF) generation for resolution-independent scaling with GPU-accelerated outlines, shadows, and glow. Offline `fontgen` CLI to pre-bake SDF atlases, or generate at runtime. Alignment, word wrapping, and line height overrides.
